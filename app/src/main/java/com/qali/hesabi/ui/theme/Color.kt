...
val md_theme_light_primary = Color(0xFFB85C00) // Orange-brown
val md_theme_light_onPrimary = Color(0xFFFFFFFF)
val md_theme_light_primaryContainer = Color(0xFFFFE0B2) // Light orange
val md_theme_light_onPrimaryContainer = Color(0xFF4E2600)
val md_theme_light_secondary = Color(0xFF757575) // Gray
val md_theme_light_onSecondary = Color(0xFFFFFFFF)
val md_theme_light_secondaryContainer = Color(0xFFF5F5F5) // Light gray
val md_theme_light_onSecondaryContainer = Color(0xFF212121)
val md_theme_light_tertiary = Color(0xFF212121) // Black
val md_theme_light_onTertiary = Color(0xFFFFFFFF)
val md_theme_light_tertiaryContainer = Color(0xFFE0E0E0) // Gray
...
val md_theme_light_inversePrimary = Color(0xFFFFA040)
val md_theme_light_shadow = Color(0xFF000000)
val md_theme_light_surfaceTint = Color(0xFFB85C00)
val md_theme_light_outlineVariant = Color(0xFFE0E0E0)
val md_theme_light_scrim = Color(0xFF000000)

val md_theme_dark_primary = Color(0xFFFFA040) // Orange-brown accent
val md_theme_dark_onPrimary = Color(0xFF4E2600)
val md_theme_dark_primaryContainer = Color(0xFFB85C00)
...
val md_theme_dark_tertiary = Color(0xFFFFFFFF) // White
val md_theme_dark_onTertiary = Color(0xFF212121)
val md_theme_dark_tertiaryContainer = Color(0xFF757575)
...
val md_theme_dark_surfaceVariant = Color(0xFF757575)
...
val md_theme_dark_inversePrimary = Color(0xFFB85C00)
val md_theme_dark_shadow = Color(0xFF000000)
val md_theme_dark_surfaceTint = Color(0xFFFFA040)
val md_theme_dark_outlineVariant = Color(0xFF757575)
val md_theme_dark_scrim = Color(0xFF000000)

val seed = Color(0xFFB85C00)
